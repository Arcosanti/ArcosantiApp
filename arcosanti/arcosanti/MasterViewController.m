...
- (void)configureCell:(NewsTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    RSS *newsItem = [self.fetchedResultsController objectAtIndexPath:indexPath];
    
    cell.titleLabel.text = newsItem.articleTitle;
    cell.descriptionLabel.text = newsItem.articleDescription;
    cell.newsImage.image = nil;
    
    NSString *jpegFilePath = [NSHomeDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"Documents/%@",[newsItem.articleImage lastPathComponent]]];
    ...
    else
    {
        ...
        operation.tableCell = cell;
        operation.imageUrlString = newsItem.articleImage;
        
        [[NSOperationQueue mainQueue]addOperation:operation];
        
        NSLog(@"%@ ",[[NSOperationQueue mainQueue]operations]);
